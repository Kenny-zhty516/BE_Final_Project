...
class GreetingServiceConstruct(Construct):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        service = ecsp.ApplicationLoadBalancedFargateService(
            ...
            desired_count=1,
            cpu=1024,
            task_subnets=ec2.SubnetSelection(subnets=[private_subnet]),
    ...
    def _prepare_ecs_cluster(self, vpc: ec2.IVpc) -> ecs.ICluster:
        ...
        """
        cluster = ecs.Cluster(
            self, "FargateCPCluster", vpc=vpc, enable_fargate_capacity_providers=True
        )
        return cluster
    ...
    def _prepare_task_definition(self) -> ecs.FargateTaskDefinition:
        ...
        task_definition = ecs.FargateTaskDefinition(
            self, "GreetingTaskDef", memory_limit_mib=1024, cpu=512
        )
